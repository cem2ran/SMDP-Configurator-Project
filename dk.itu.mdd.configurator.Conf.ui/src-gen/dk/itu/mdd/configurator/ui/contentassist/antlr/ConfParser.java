		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGroupedAccess().getConstrainsAssignment_1_1(), "rule__Grouped__ConstrainsAssignment_1_1");
					put(grammarAccess.getGroupedAccess().getConstrainsAssignment_1_2_1(), "rule__Grouped__ConstrainsAssignment_1_2_1");
